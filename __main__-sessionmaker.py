...
async def create_user(
    # первый аргумент заменяется на sessionmaker
    ...
    # не нужно передавать параметры сюда, они уже "заложены"
    # в sessionmaker
...
async def main():
    ...
    await create_user(
        # первый аргумент меняется на sessionmaker
        Sessionmaker,
        telegram_id=345345345,
        first_name="Linus",
        last_name="Torvalds"
    )
